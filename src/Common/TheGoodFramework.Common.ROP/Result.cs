...
namespace TGF.Common.ROP
{
    ...
    /// <summary>
    /// Base class of <see cref="Result{T}"/> without Value.
    /// </summary>
    public class ResultBase
    {
        public readonly ImmutableArray<Error> ErrorList;
        ...
        public ResultBase(ImmutableArray<Error> aErrorList)
        {
    ...
    public class Result<T> : ResultBase
    {
        ...
        public Result(ImmutableArray<Error> aErrorList) : base(aErrorList)
        {
            Value = default;
        }
