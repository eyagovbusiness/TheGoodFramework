...
{  
    ...
    public abstract class QuieryRepository<TRepository, TDbContext, T, TKey>(TDbContext aContext, ILogger<TRepository> aLogger, ISpecificationEvaluator specificationEvaluator) : IQueryRepositoryInternal<T, TKey>
    ...
    where TKey : struct, IEquatable<TKey>
    {
        ...
        public QuieryRepository(TDbContext aContext, ILogger<TRepository> aLogger)
