...
namespace TGF.CA.Infrastructure.DB.Repository.CQRS.EntityRepository
{
    ...
    public abstract class EntitiyQueryRepository<TRepository, TDbContext, T, TKey>(TDbContext aContext, ILogger<TRepository> aLogger, ISpecificationEvaluator specificationEvaluator)
    ...
    where TKey : struct, IEquatable<TKey>
    {
        ...
        public EntitiyQueryRepository(TDbContext aContext, ILogger<TRepository> aLogger)
