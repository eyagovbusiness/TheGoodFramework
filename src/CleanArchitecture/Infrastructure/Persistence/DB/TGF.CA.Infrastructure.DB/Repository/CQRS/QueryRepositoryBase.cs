...
{   /// <summary>
    ...
    public abstract class QueryRepositoryBase<TRepository, TDbContext, T, TKey> : IQueryRepositoryInternal<T, TKey>
    ...
    where TKey : struct, IEquatable<TKey>
    {
        ...
        public QueryRepositoryBase(TDbContext aContext, ILogger<TRepository> aLogger, ISpecificationEvaluator specificationEvaluator)
        {
            _context = aContext;
            _logger = aLogger;
