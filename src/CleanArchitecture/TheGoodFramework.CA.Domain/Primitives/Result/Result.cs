...
namespace TGF.CA.Domain.Primitives.Result
{
    ...
    public class Result
    {
        ...
        /// <remarks>Placed in this class and not in the generic one Result<TValue> to avoid specifying on this method usage twice the generic type.</remarks>
        ...
        /// Also this method is placed in this class and not in the generic one Result<TValue> to avoid specifying on this method usage twice the generic type.
        /// </remarks>
